...
values
	((select codigo from country where nome = 'Brasil'),'Ceará'),
	((select codigo from country where nome = 'Brasil'),'Goiás'),
	((select codigo from country where nome = 'Brasil'),'Sergipe'),
	((select codigo from country where nome = 'Brasil'),'São Paulo'),
...
insert into 
	city(cod_state,nome)
values
	((select codigo from state where nome = 'Ceará'),'Fortaleza'),
	((select codigo from state where nome = 'Ceará'),'Juazeiro'),
	((select codigo from state where nome = 'Ceará'),'Sobral'),
	((select codigo from state where nome = 'Goiás'),'Barretos'),
	((select codigo from state where nome = 'São Paulo'),'São Paulo'),
	((select codigo from state where nome = 'São Paulo'),'Osasco'),
	((select codigo from state where nome = 'São Paulo'),'Carapicuíba'),
